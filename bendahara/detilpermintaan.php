    ...
    <div class="row">
        <div class="col-sm-12">
         <div class="box box-primary">
            ...
            <div class="box-body">                   
                <a href="index?p=datapermintaan" style="margin:10px;" class="btn btn-success"><i class='fa fa-backward'>  Kembali</i></a>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>                                            
                                    ...
                                    <a  href="?p=editpesanminta&id=<?=$row['id_permintaan']; ?>"><span data-placement='top' data-toggle='tooltip' title='Edit'><button   class="btn btn-primary" >Edit</button></span></a>            
