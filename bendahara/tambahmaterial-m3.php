            ...
            <div class="box box-primary">
                ...
                <form method="post"  action="add-proses-m3.php" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="id_jenis" value="3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                &nbsp;
                                <input type="reset" class="btn btn-danger" value="Batal">           <a href="index?p=material-m3&id_jenis=3" style="margin:10px;" class="btn btn-success"><i class='fa fa-backward'>  Kembali</i></a>  
