            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 col-xs-12">
                    <div class="box box-primary">
                        ...
                        <form method="post"  action="edit-proses-m3.php" class="form-horizontal">
                            <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="index?p=material-m3&id_jenis=3" style="margin:10px;" class="btn btn-success"><i class='fa fa-backward'>  Kembali</i></a>                                                                             
                                </div>
                            </div>
                        </form>
                    </div>
