...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $query = mysqli_query($koneksi, "SELECT * FROM stokbarang WHERE id_kode_brg = '$id' ");
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2 col-xs-12">
                <div class="box box-primary">
                    ...
                    <form method="post"  action="edit-proses-stok.php" class="form-horizontal">
                        <div class="box-body">
                         <input type="hidden" name="id" value="<?= $row2['id_kode_brg']; ?>">
                        ...
                        <div class="form-group ">
                            <label for="kode_brg" class="col-sm-offset-1 col-sm-3 control-label">Supplier</label>
                            <div class="col-sm-4">
                                <input type="text" readonly  value="<?= $row2['supplier']; ?>" class="form-control" name="kode_brg">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            &nbsp;
                            <input type="reset" class="btn btn-danger" value="Batal">              <a href="index?p=stokbarang" style="margin:10px;" class="btn btn-success"><i class='fa fa-backward'>  Kembali</i></a>                                                         
                        </div>
                    </div>
                </form>
            </div>
