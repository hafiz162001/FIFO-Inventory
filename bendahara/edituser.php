                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <option value="">--Pilih Level--</option>
                                    ...
                                    <option  <?php if($row2['level'] == "instansi") echo "selected"; ?>  value="instansi">Pegawai</option>
                                    <!-- <option  <?php if($row2['level'] == "bendahara") echo "selected"; ?> value="bendahara">Bendahara</option>
                                    <option  <?php if($row2['level'] == "kepala") echo "selected"; ?> value="kepala">Kepala</option>
