...
}else if ($page=="tambahsupplier") {
    include_once "tambahsupplier.php";
}
else if ($page=="editsupplier") {
    include_once "editsupplier.php";
}
else if ($page=="hapussupplier") {
    include_once "hapussupplier.php";
}
...
else if ($page=="tambahstok"){
    include_once "tambahstok.php";
}
else if ($page=="editstok"){
    include_once "editstok.php";
}
elseif ($page=="hapusstok") {
    include_once "hapusstok.php";
}
