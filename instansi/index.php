    ...
    <section class="sidebar">
     <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="index"><i></i> (<?=  $_SESSION['jabatan']; ?>)</a>
        </div>
      </div>      
      <ul class="sidebar-menu">
        ...
        <li><a href="index?p=datapesanan"><i class="fa fa-files-o"></i> Data Permintaan Barang</a></li>
...
?>   
  ...
  <footer class="main-footer"> 
   <marquee hspace="40" width="full-width">Setelah permintaan di konfirmasi oleh Karyawan,  harap segera langsung  dengan membawa Bukti Permintaan yang telah disahkan oleh Kepala Toko.</marquee>
   <strong>Copyright &copy; Ahmad Nafiudin 2022 </strong>
 </footer>
