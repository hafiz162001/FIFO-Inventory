                            ...
                            <tr>
                                ...
                                if (mysqli_num_rows($query)) {
                                    while($row=mysqli_fetch_assoc($query)):
                                     ...
                                     <td> <?= $row['instansi']; ?> </td> 
                                     <td>                                                                                                                                                                                                        
                                        <a href="?p=detilpermintaan&unit=<?= $row['unit'];?>&tgl=<?= $row['tgl_permintaan']; ?>"><span data-placement='top' data-toggle='tooltip' title='Detail Permintaan'><button    class="btn btn-info">Detail Permintaan</button></span></a>       
