 ...
 <body class="hold-transition skin-red-light sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
     <div class="logo">
      <span class="logo-lg" > <a href="index"></a><b href="">Toko Wida</b></span>
    </div>
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="index?p=material&id_jenis=1" ><i class="fa fa-circle-o"></i>ATK</a></li>
            <li><a href="index?p=material&id_jenis=2" ><i class="fa fa-circle-o"></i>ALAT KEBERSIHAN</a></li>
            <li><a href="index?p=material&id_jenis=3" ><i class="fa fa-circle-o"></i>PERLENGKAPAN LAIINYA</a></li>
         </ul>
        </li>
      <!-- <li><a href="index?p=datapermintaan"><i class="fa fa-retweet"></i> <span>Data Permintaan</span></a></li>    -->      
  </ul>
</section>
<!-- /.sidebar -->
</aside>
...
<footer class="main-footer">
 <marquee direction="right" width="full-width">Kepala Toko.</marquee>
 <strong>Copyright &copy; Nurjaman 2023 </strong>
</footer>
